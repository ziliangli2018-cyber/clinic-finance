...
try {
  ...
  await expect(page.getByRole('heading', { name: 'Make room for a clearer picture' })).toBeVisible({ timeout: 15000 });
  ...
  console.log('PASS: browser signup, organisation onboarding, server mock sync, personal credit card, refresh persistence, session reload and sign out.');
